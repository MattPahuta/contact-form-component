...
function Confirmation({ onClose }) {
  ...
  return (
    <dialog className="animate-in fade-in zoom-in backdrop:animate-in backdrop:fade-in m-auto w-auto h-fit max-w-md p-0 rounded-lg shadow-lg backdrop:bg-black/50 backdrop:backdrop-blur-sm backdrop:duration-300 starting:scale-95 backdrop:starting:opacity-0">
